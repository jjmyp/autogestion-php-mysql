$(document).ready(function () {
  ...
  $("#formRegistro").validate({
    ...
    messages: {
      clave_registro: {
        required: "Digita la clave de registro",
  ...
  $('#btnSiguiente').on('click', function (event) {
    ...
    // if (account_id_local_storage == '' || validation_id_local_storage == '' ||
    //   account_id_local_storage == null || validation_id_local_storage == null ||
    //   account_id_local_storage == undefined || validation_id_local_storage == undefined) {
    //   $.ajax({
    ...
    //       var account_id = objData.account_id
    //       $.ajax({
    ...
    //               localStorage.setItem("account_id", objData.account_id);
    //             }
    //           })
    //         }
    //       })
  ...
  $('#btnRegistrarUsuario').on('click', function (event) {
    ...
    formData.append('account_id', 'SDAFASDFS-SDASDFASDF')
    formData.append('contrasena', null)
    formData.append('confirmar_contrasena', null)
    formData.append('account', 'GOOGLE')
    ...
    //   token = codigo1 + '' + codigo2 + '' + codigo3 + '' + codigo4 + '' + codigo5 + '' + codigo6
    ...
    //         Message('La validación ya no está disponible, porfavor reenvie nuevamente el codigo.', 'danger')
    //       } else {
    ...
    //               var urlimg = base_url + 'Assets/images/numeroverificado.png'
    //               var img = `<img width="350px" src="${urlimg}"> ` 
    //               $('#logo').after(img); 
    //               $('#btnFinish').show()
    //             } else {
    //               Message('Hubo un problema al registrarse', 'danger')
